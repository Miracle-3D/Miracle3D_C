...
for ((i=1;i<=$NUM_PLAYERS;i++)); do
	...
	2|4)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 3 --paramsfile paramfiles/defaultParams_t2.txt &#>  /dev/null &
  ...
  9|3)
	...
	*)
	    ...
	    "$BINARY_DIR/$AGENT_BINARY" $opt --unum $i --type 4 --paramsfile paramfiles/defaultParams_t1.txt &#> /dev/null &
