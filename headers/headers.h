...
enum SkillType {
    ...
    SKILL_LONGASS_LEFT_LEG,
    SKILL_LONGASS_RIGHT_LEG,

    SKILL_SLOWASS_LEFT_LEG,
    SKILL_SLOWASS_RIGHT_LEG,
...
#define KICK_IK 2
#define KICK_DAJIAO 3
#define KICK_LONGASS 4
#define KICK_SLOWASS 5
