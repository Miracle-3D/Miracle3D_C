...
// INVERSE KINEMATICS KICKS
    ...
    string2enum["SKILL_LONGASS_LEFT_LEG"] = SKILL_LONGASS_LEFT_LEG;
    enum2String[SKILL_LONGASS_LEFT_LEG] = "SKILL_LONGASS_LEFT_LEG";

    string2enum["SKILL_LONGASS_RIGHT_LEG"] = SKILL_LONGASS_RIGHT_LEG;
    enum2String[SKILL_LONGASS_RIGHT_LEG] = "SKILL_LONGASS_RIGHT_LEG";

    string2enum["SKILL_SLOWASS_LEFT_LEG"] = SKILL_SLOWASS_LEFT_LEG;
    enum2String[SKILL_SLOWASS_LEFT_LEG] = "SKILL_SLOWASS_LEFT_LEG";

    string2enum["SKILL_SLOWASS_RIGHT_LEG"] = SKILL_SLOWASS_RIGHT_LEG;
    enum2String[SKILL_SLOWASS_RIGHT_LEG] = "SKILL_SLOWASS_RIGHT_LEG";
    ...
    enum2String[SKILL_MIDDLE_BLOCK] = "SKILL_MIDDLE_BLOCK"; 
