...
double NaoBehavior::getStdNameParameter(const SkillType kick_skill, const string& parameter) {
    ...
    case SKILL_DAJIAO_RIGHT_LEG:
        prefix = "dajiao_";
        break;
    case SKILL_LONGASS_LEFT_LEG:
    case SKILL_LONGASS_RIGHT_LEG:
        prefix = "longpass_";
        break;
    case SKILL_SLOWASS_LEFT_LEG:
    case SKILL_SLOWASS_RIGHT_LEG:
        prefix = "slowpass_";
        break;
    default:
...
void NaoBehavior::getSkillsForKickType(int kickType, SkillType skills[]) {
    ...
    case KICK_DAJIAO:
        ...
        break;
    case KICK_LONGASS:
        skills[0] = SKILL_LONGASS_LEFT_LEG;
        skills[1] = SKILL_LONGASS_RIGHT_LEG;
        break;
    case KICK_SLOWASS:
        skills[0] = SKILL_SLOWASS_LEFT_LEG;
        skills[1] = SKILL_SLOWASS_RIGHT_LEG;
        break;
    default:
        skills[0] = SKILL_KICK_LEFT_LEG;
        skills[1] = SKILL_KICK_RIGHT_LEG;
